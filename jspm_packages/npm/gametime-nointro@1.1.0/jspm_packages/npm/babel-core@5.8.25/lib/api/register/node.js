...
(function(process) {
  ...
  if (process.env.running_under_istanbul) {
    ...
    _fs2["default"].readFileSync = function(filename) {
      if (istanbulMonkey[filename]) {
        ...
        var code = compile(filename, {auxiliaryCommentBefore: "istanbul ignore next"});
  ...
  exports["default"] = function() {
    ...
    if (opts.only != null)
      only = util.arrayify(opts.only, util.regexify);
    if (opts.ignore != null)
      ignore = util.arrayify(opts.ignore, util.regexify);
    if (opts.extensions)
