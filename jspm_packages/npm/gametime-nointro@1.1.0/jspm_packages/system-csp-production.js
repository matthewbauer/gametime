      ...
      !function(e) {
        ...
        function S(e, t) {
          ...
          return this.builder ? this.normalize(r.module, t).then(function(t) {
            return r.conditionModule = t, e.replace(B, "#{" + w(r) + "}");
          }) : k.call(this, r, t, !1).then(function(t) {
            if ("string" != typeof t)
        ...
        var U = ["main", "format", "defaultExtension", "meta", "map", "basePath", "depCache"];
        c(function(e) {
          return function() {
        ...
        c(function(e) {
          return function() {
            e.call(this), this.baseURL = M.substr(0, M.lastIndexOf("/") + 1), this.set("@empty", this.newModule({})), "undefined" != typeof require && require.resolve && "undefined" != typeof process && (this._nodeRequire = require);
          };
        ...
        d("locate", function(e) {
          ...
          d("pushRegister_", function(e) {
            ...
            return function(o) {
              var d = this;
              return o.metadata.scriptLoad && (O || j) ? j ? n(d, o) : new Promise(function(t, n) {
                function c(e) {
                ...
                function m() {
                  if (e.System = a, h.detachEvent) {
                    h.detachEvent("onreadystatechange", c);
                    for (var t = 0; t < i.length; t++)
                      i[t].script == h && i.splice(t, 1);
                  } else
                    h.removeEventListener("load", c, !1), h.removeEventListener("error", f, !1);
                  r.removeChild(h);
                }
                var h = document.createElement("script");
                h.async = !0, o.metadata.integrity && h.setAttribute("integrity", o.metadata.integrity), s ? (h.attachEvent("onreadystatechange", c), i.push({
                  script: h,
                  load: o
                })) : (h.addEventListener("load", c, !1), h.addEventListener("error", f, !1)), a = e.System, h.src = o.address, r.appendChild(h);
              }) : t.call(this, o);
            };
          });
        }(), function() {
        ...
        }), D = new l, D.version = "0.19.1 CSP", "object" == typeof exports && (module.exports = a), e.Reflect = e.Reflect || {}, e.Reflect.Loader = e.Reflect.Loader || a, e.Reflect.global = e.Reflect.global || e, e.LoaderPolyfill = a, D || (D = new o, D.constructor = o), "object" == typeof exports && (module.exports = D), e.System = D;
