    ...
    function e() {
      !function(e) {
        ...
        function E(e, t) {
          ...
          var r = x(n[0].substr(2, n[0].length - 3));
          return this.builder ? this.normalize(r.module, t).then(function(t) {
            return r.conditionModule = t, e.replace(X, "#{" + w(r) + "}");
          }) : S.call(this, r, t, !1).then(function(t) {
            if ("string" != typeof t)
        ...
        function k(e, t) {
          ...
          if (-1 == n)
            return Promise.resolve(e);
          var r = x(e.substr(n + 2));
          return this.builder ? this.normalize(r.module, t).then(function(t) {
            return r.module = t, e.substr(0, n) + "#?" + w(r);
        ...
        var R = "undefined" == typeof window && "undefined" != typeof self && "undefined" != typeof importScripts,
            ...
            P = "undefined" != typeof process && !!process.platform.match(/^win/);
        ...
        if ("undefined" != typeof document && document.getElementsByTagName) {
          ...
          z = "file://" + (P ? "/" : "") + process.cwd() + "/", P && (z = z.replace(/\\/g, "/"));
        else {
          ...
          a.prototype = {
            ...
            load: function(e, t) {
              ...
              return n.modules[e] ? (S(n.modules[e], [], n), Promise.resolve(n.modules[e].module)) : n.importPromises[e] || y(this, e, s(n, e, {}).then(function(t) {
                return delete n.importPromises[e], w(n, t);
              }));
            },
            module: function(e, t) {
              var n = o();
        ...
        if ("undefined" != typeof XMLHttpRequest)
          ...
          I = function(e, t, n, r) {
            ...
            return A = A || require("fs"), e = P ? e.replace(/\//g, "\\").substr(8) : e.substr(7), A.readFile(e, function(e, t) {
              if (e)
                return r(e);
              var a = t + "";
        ...
        var U,
            J = ["main", "format", "defaultExtension", "meta", "map", "basePath", "depCache"];
        !function() {
          function n(t, n) {
          ...
          var l = "undefined" != typeof btoa;
          if (R || j && window.chrome && window.chrome.extension)
            U = function(o) {
            ...
            $__curScript = c[c.length - 1], U = function(e) {
              u || (u = document.head || document.body || document.documentElement);
              ...
              }, n(this, e), e.metadata.integrity && o.setAttribute("integrity", e.metadata.integrity), e.metadata.nonce && o.setAttribute("nonce", e.metadata.nonce), u.appendChild(o), u.removeChild(o), r(), window.onerror = i, s)
                throw s;
            };
          } else {
            var f = "vm",
            ...
            U = function(e) {
              ...
              try {
                n(this, e), m.runInThisContext(a(e)), r();
              } catch (o) {
        ...
        d("locate", function(e) {
        ...
        }), l.prototype.warnings = !1, l.prototype.config = function(e) {
          function t(e) {
            for (var t in e)
              return !0;
          }
          if ("warnings" in e && (this.warnings = e.warnings), e.baseURL) {
            if (t(this.packages) || t(this.meta) || t(this.depCache) || t(this.bundles))
          ...
          if (e.packages)
            for (var n in e.packages) {
              ...
              f = f.substr(0, f.length - 1), !this.packages[f] && this.defaultJSExtensions && ".js" != n.substr(n.length - 3, 3) && (f = f.substr(0, f.length - 3)), this.packages[f] = this.packages[f] || {};
          ...
          function r(e, t, n, r, o, s, i) {
            ...
            !l && n.meta && f(n.meta, t, o, function(e, t, n) {
          ...
          function u(e, t) {
            ...
            return n && n.configured ? Promise.resolve() : g[t.pkgName] || (g[t.pkgName] = Promise.resolve().then(function() {
              for (var r = [],
                ...
                (function(a) {
                  r.push(e.fetch({
                    ...
                    r.systemjs && (r = r.systemjs);
                    for (var a in r)
                      -1 == O.call(J, a) && delete r[a];
                    if (r.main instanceof Array && (r.main = r.main[0]), n && h(r, n), r.depCache)
                      for (var o in r.depCache)
                        if ("./" != o.substr(0, 2)) {
                          var s = e.normalizeSync(o);
                          e.depCache[s] = (e.depCache[s] || []).concat(r.depCache[o]);
                        }
          ...
          function t() {
            if (l && "interactive" === l.readyState)
              return l;
            for (var e = 0; e < i.length; e++)
              if ("interactive" == i[e].script.readyState)
                return l = i[e].script, i[e].load;
          }
          function n(e, t) {
            return new Promise(function(e, n) {
              t.metadata.integrity && n(new Error("Subresource integrity checking is not supported in web workers.")), o = t;
              try {
                importScripts(t.address);
              } catch (r) {
                o = null, n(r);
              }
              o = null, t.metadata.entry || n(new Error(t.address + " did not call System.register or AMD define")), e("");
            });
          }
          ...
          d("pushRegister_", function(e) {
            return function(n) {
              return e.call(this, n) ? !1 : (o ? this.reduceRegister_(o, n) : s ? this.reduceRegister_(t(), n) : u.push(n), !0);
            };
          }), d("fetch", function(t) {
            return function(o) {
              var d = this;
              return o.metadata.scriptLoad && (j || R) ? R ? n(d, o) : new Promise(function(t, n) {
                function c(e) {
                    ...
                    if (l || u.length)
                      if (s)
                        ...
                        for (var r = 0; r < u.length; r++)
                          d.reduceRegister_(o, u[r]);
                        u = [];
                      }
                    else
                      d.reduceRegister_(o);
                    m(), o.metadata.entry || o.metadata.bundle || n(new Error(o.name + " did not call System.register or AMD define")), t("");
                  }
                }
                function f(e) {
                  m(), n(new Error("Unable to load script " + o.address));
                }
                function m() {
                  if (e.System = a, p.detachEvent) {
                    p.detachEvent("onreadystatechange", c);
                    for (var t = 0; t < i.length; t++)
                      i[t].script == p && i.splice(t, 1);
                  } else
                    p.removeEventListener("load", c, !1), p.removeEventListener("error", f, !1);
                  r.removeChild(p);
                }
                var p = document.createElement("script");
                p.async = !0, o.metadata.integrity && p.setAttribute("integrity", o.metadata.integrity), s ? (p.attachEvent("onreadystatechange", c), i.push({
                  script: p,
                  load: o
                })) : (p.addEventListener("load", c, !1), p.addEventListener("error", f, !1)), a = e.System, p.src = o.address, r.appendChild(p);
              }) : t.call(this, o);
            };
          });
        }(), function() {
          ...
          l.prototype.register = function(e, t, n) {
            ...
            return function(e, t) {
              if (t) {
                var n = t.entry;
                if (n.name && (n.name in this.defined || (this.defined[n.name] = n), e.metadata.bundle = !0), !n.name || n.name == e.name) {
                  if (e.metadata.entry)
                    throw new Error("Multiple anonymous System.register calls in module " + e.name + ". If loading a bundle, ensure all the System.register calls are named.");
                  e.metadata.format || (e.metadata.format = "register"), e.metadata.entry = n;
                }
              }
            };
          }), c(function(e) {
            ...
            return function(s) {
              ...
              if (s.metadata.format || (n.lastIndex = 0, r.lastIndex = 0, (r.exec(s.source) || n.exec(s.source)) && (s.metadata.format = "cjs")), "cjs" == s.metadata.format) {
                ...
                s.metadata.entry = c, c.deps = u, c.executingRequire = !0, c.execute = function(t, n, r) {
                  ...
                  var u = s.address || "",
                      d = u.split("/");
                  d.pop(), d = d.join("/"), "file:///" == u.substr(0, 8) ? (u = u.substr(7), d = d.substr(7), P && (u = u.substr(1), d = d.substr(1))) : o && u.substr(0, o.length) === o && (u = u.substr(o.length), d = d.substr(o.length));
                  var c = e.define;
          ...
          return function() {
            ...
            a.amd = {}, d("reduceRegister_", function(e) {
              return function(t, n) {
                ...
                var r = t.metadata,
                    a = n.entry;
                if (r.format = "amd", a.name)
                  r.entry || r.bundle ? r.entry = void 0 : r.entry = a, r.bundle = !0, this.defined[a.name] = a;
                else {
                  if (r.entry)
            ...
            return function(n) {
              ...
              if ("amd" == n.metadata.format || !n.metadata.format && n.source.match(e))
                if (n.metadata.format = "amd", r.builder || r.execute === !1)
                  ...
                  if (U.call(r, n), a(), !n.metadata.entry && !n.metadata.bundle)
        ...
        }(), F = new l, F.version = "0.19.1 Standard", "object" == typeof exports && (module.exports = a), e.Reflect = e.Reflect || {}, e.Reflect.Loader = e.Reflect.Loader || a, e.Reflect.global = e.Reflect.global || e, e.LoaderPolyfill = a, F || (F = new o, F.constructor = o), "object" == typeof exports && (module.exports = F), e.System = F;
